...
window.onload = function() {
    ...
    document.querySelectorAll('.category_buttons a').forEach(a => {
		...
		// It checks if the current <a> link matches the selected category
    ...
    if (category === 'all') {
        ...
        articlesHtml = `
			...
			<a href="#">
                ...
                <h3><a href="#" style="color:black;">AI: The Next Frontier in Healthcare</a></h3> 
			 <a href="?category=ai">
			...
			<a href="#">
				...
				<h3><a href="#" style="color: black;">AI and Privacy: How Machine Learning is Impacting Data Security</a></h3>
            </div>
			...
			<a href="#">
				...
				<h3><a href="#" style="color: black;">Ethics in AI: Navigating the Dangers of Machine Intelligence</a></h3>
            </div>
			...
			<a href="#">
				...
				<h3><a href="#" style="color: black;">AI in Healthcare: The Promise and Challenges of Machine Learning</a></h3>
            </div>
			...
			<a href="?category=gear">
                ...
                <h3><a href="#" style="color: black;">Polaroid Flip: A Retro-Inspired Instant Camera for Modern Times</a></h3>			
            </div>
			...
			<a href="#">
                ...
                <h3><a href="#" style="color: black;">The Quest to Colonize Mars</a></h3>
            </div>
			...
			<a href="#">
				...
				<h3><a href="#" style="color: black;">The Future of Smart Gear: How Wearables Are Changing Our Lives</a></h3>
            </div>
			...
			<a href="#">
				...
				<h3><a href="#" style="color: black;">The Battle of AI Assistants: Siri vs. Alexa vs. Google Assistant</a></h3>
            </div>
			...
			<a href="#">
				...
				<h3><a href="#" style="color: black;">Private Space Ventures: How Startups are Shaping the Final Frontier</a></h3>
				</div>
				...
				<h3><a href="#" style="color: black;">Tech Gear for Home Offices: Must-Have Devices for Remote Work</a></h3>
            </div>
			...
			<a href="#">
                ...
                <h3><a href="#" style="color: black;">Amazon targets April 9 launch of first Kuiper internet satellites</a></h3>
            </div>
			...
			<a href="#">
              ...
              <h3><a href="#" style="color: black;">Quantum Computing: The Disruptive Force</a></h3>
           </div>
			...
			<a href="#">
				...
				<h3><a href="#" style="color: black;">Space Tourism: The Future of Commercial Travel Beyond Earth</a></h3>
            </div>
		   ...
		   <a href="?category=space">
                ...
                <h3><a href="#" style="color: black;">SpaceX and the Future of Mars Exploration</a></h3>				          
		   </div>
		   ...
		   <a href="#">
				...
				<h3><a href="#" style="color: black;">The Role of AI in Climate Change: Can Machines Help Save the Planet?</a></h3>
            </div>
			...
			<a href="#">
				...
				<h3><a href="#" style="color: black;">Astrobiology: The Hunt for Life Beyond Our Solar System</a></h3>
            </div>
			...
			<a href="#">
				...
				<h3><a href="#" style="color: black;">AI in Creative Industries: How Machines Are Rewriting the Rules of Art and Design</a></h3>
            </div>
		   ...
		   <a href="#">
				...
				<h3><a href="#" style="color: black;">The Evolution of Gaming Gear: From Controllers to Virtual Reality</a></h3>
            </div>
			...
			<a href="#">
				...
				<h3><a href="#" style="color: black;">AI Breakthroughs: The Most Exciting Developments in 2025</a></h3>
            </div>
			...
			<a href="#">
                ...
                <h3><a href="#" style="color: black;">AI and the Future of Autonomous Vehicles</a></h3>
            </div>
		   ...
		   <a href="#">
                ...
                <h3><a href="#" style="color: black;">NASA's Artemis: Returning to the Moon</a></h3>
            </div>
			...
			<a href="#">
				...
				<h3><a href="#" style="color: black;">The Ultimate Tech Gear Setup in 2025</a></h3> 
            </div>
			...
			<a href="#">
                ...
                <h3><a href="#" style="color: black;">AI in Medicine: Breakthroughs and Challenges</a></h3>
            </div>
		...
		<a href="#">
            ...
            <h3><a href="#" style="color: black;">Blockchain: Beyond Bitcoin</a></h3>
        </div>
		...
		<a href="#">
            ...
            <h3><a href="#" style="color: black;">Automation and the Future Workforce</a></h3>			
        </div>
		...
		<a href="#">
				...
				<h3><a href="#" style="color: black;">The Search for Alien Life: Breakthroughs in Exoplanet Discovery</a></h3>
            </div>
			...
			<a href="#">
				...
				<h3><a href="#" style="color: black;">Artificial General Intelligence: Are We Close to Creating Superintelligent Machines?</a></h3>
            </div>
			...
			<a href="#">
				...
				<h3><a href="#" style="color: black;">Building the Next Generation of Space Stations: A Look at Orbital Habitats</a></h3>
            </div>
